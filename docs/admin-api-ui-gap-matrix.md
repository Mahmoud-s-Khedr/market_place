...
| User details | Full user profile details (name, phone, photo, ID...) | `GET /admin/users/:id` (detailed admin profile DTO) | None | Missing | No admin user detail read endpoint | Add `GET /admin/users/:id` with required identity fields | P0 |
